...
public class JdbcOrderRepository implements OrderRepository {
    ...
    public TacoOrder save(TacoOrder order) {
        ...
        PreparedStatementCreator psc =
                pscf.newPreparedStatementCreator(Arrays.asList(order.getDeliveryName(),
                        order.getDeliveryStreet(), order.getDeliveryCity(),
        ...
        long orderId = extracted(keyHolder).longValue();
        order.setId(orderId);
    ...
    private Number extracted(GeneratedKeyHolder keyHolder) {
    ...
    private long saveTaco(Long orderId, int orderKey, Taco taco) {
        ...
        GeneratedKeyHolder keyHolder = new GeneratedKeyHolder();
        jdbcOperations.update(psc, keyHolder);
        long tacoId = extracted(keyHolder).longValue();
        taco.setId(tacoId);
